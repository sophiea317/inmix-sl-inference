...
function testing_blocksLoopBegin(testing_blocksLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    testing_blocks.forEach(function() {
...
function testing_loop_repLoopBegin(testing_loop_repLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    testing_loop_rep.forEach(function() {
...
function setup_blockRoutineBegin(snapshot) {
  return async function () {
    ...
    setup_blockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function setup_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    setup_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pair1_dispRoutineBegin(snapshot) {
  return async function () {
    ...
    pair1_dispComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pair1_1backRoutineBegin(snapshot) {
  return async function () {
    ...
    pair1_1backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pair2_dispRoutineBegin(snapshot) {
  return async function () {
    ...
    pair2_dispComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pair2_1backRoutineBegin(snapshot) {
  return async function () {
    ...
    pair2_1backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function between_blocks_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    between_blocks_breakComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function testing_block_setupRoutineBegin(snapshot) {
  return async function () {
    ...
    testing_block_setupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
